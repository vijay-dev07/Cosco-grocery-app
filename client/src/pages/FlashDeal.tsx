    ...
    <div className="min-h-screen bg-app-cream">
      ...
      <div className="bg-linear-to-r from-app-orange to-app-orange-dark text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-8 text-center">
          ...
          <p className="text-white/80 max-w-md mx-auto">Limited-time offers on your favourite organic products. Grab them before they're 
          gone!</p>
        </div>
      </div>
        ...
        {loading ? (<Loading/>) : (
          products.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-sm text-app-text-light">Please back soon for amazing offers</p>
            </div>
          ) : (
